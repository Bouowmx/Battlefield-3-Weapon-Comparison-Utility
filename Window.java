...
public final class Window extends JFrame {
	...
	String[] columnNames1 = {"Output", "Weapon 1", "Weapon 2"};
	
	Object[][] outputData = {
		new Object[] {"<html><b>DAMAGE</b>", "<html><b>WEAPON 1</b>", "<html><b>WEAPON 2</b>"},
		new Object[] {"Max", 0, 0}, 
		new Object[] {"Min", 0, 0},
		new Object[] {"Dropoff Start", 0, 0},
		new Object[] {"Dropoff End", 0, 0},
		new Object[] {"<html><b>OUTPUT</b>", "<html><b>WEAPON 1</b>", "<html><b>WEAPON 2</b>"}, //Output-5
		new Object[] {"Rate of Fire", 0, 0},
		new Object[] {"Muzzle Velocity", 0, 0},
		new Object[] {"Suppression", 0, 0}
	};
	
	String[] columnNames2 = {"Recoil", "Weapon 1", "Weapon 2"};
	
	Object[][] recoilData = {
		new Object[] {"<html><b>RECOIL</b>", "<html><b>WEAPON 1</b>", "<html><b>WEAPON 2</b>"}, 
	...
	String[] columnNames3 = {"ADS Spread", "Weapon 1", "Weapon 2"};
	
	//separate subtables for legibility
	
	Object[][] spreadDataADS = {
		new Object[] {"<html><b>ADS-STATION</b>", "<html><b>WEAPON 1</b>", "<html><b>WEAPON 2</b>"},
		new Object[] {"Standing", 0, 0},
		new Object[] {"Crouching", 0, 0},
		new Object[] {"Prone", 0, 0},
		new Object[] {"<html><b>ADS-MOVING</b>", "<html><b>WEAPON 1</b>", "<html><b>WEAPON 2</b>"}, //4
		new Object[] {"Moving", 0, 0},
		new Object[] {"Crouching", 0, 0},
		new Object[] {"Prone", 0, 0}
	};
	
	String[] columnNames4 = {"HIP Spread", "Weapon 1", "Weapon 2"};
	
	Object[][] spreadDataHIP = {
		new Object[] {"<html><b>HIP-STATION</b>", "<html><b>WEAPON 1</b>", "<html><b>WEAPON 2</b>"},
		new Object[] {"Standing", 0, 0},
		new Object[] {"Crouching", 0, 0},
		new Object[] {"Prone", 0, 0},
		new Object[] {"<html><b>HIP-MOVING</b>", "<html><b>WEAPON 1</b>", "<html><b>WEAPON 2</b>"}, //4
		new Object[] {"Standing", 0, 0},
		new Object[] {"Crouching", 0, 0},
		new Object[] {"Prone", 0, 0}
	};
	...
	public Window() {
		...
		compareButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				packAndCenter();
				try {weapon1Image.setIcon(new ImageIcon(ImageIO.read(getClass().getResource("/images/weapons/" + (weapon1.NAME).replace('.', '\u0000') + ".png")).getScaledInstance((int) ((double) (getWidth() - 32) / 3), -1, Image.SCALE_SMOOTH)));}
				...
				try {weapon2Image.setIcon(new ImageIcon(ImageIO.read(getClass().getResource("/images/weapons/" + (weapon2.NAME).replace('.', '\u0000') + ".png")).getScaledInstance((int) ((double) (getWidth() - 32) / 3), -1, Image.SCALE_SMOOTH)));}
				catch (Exception e2) {showErrorMessage(e2);}
				...
				outputData[0][1] = "<html><b>" + weapon1.NAME + "</b>";
				outputData[0][2] = "<html><b>" + weapon2.NAME + "</b>"; 
				...
				outputData[5][1] = "<html><b>" + weapon1.NAME + "</b>";
				outputData[5][2] = "<html><b>" + weapon2.NAME + "</b>";
				...
				recoilData[0][1] = "<html><b>" + weapon1.NAME + "</b>"; 
				recoilData[0][2] = "<html><b>" + weapon2.NAME + "</b>";
				...
				recoilData[6][1] = "<html><b>" + weapon1.NAME + "</b>"; 
				recoilData[6][2] = "<html><b>" + weapon2.NAME + "</b>";
				...
				spreadDataADS[0][1] = "<html><b>" + weapon1.NAME + "</b>"; 
				spreadDataADS[0][2] = "<html><b>" + weapon2.NAME + "</b>";
				...
				spreadDataADS[4][1] = "<html><b>" + weapon1.NAME + "</b>"; 
				spreadDataADS[4][2] = "<html><b>" + weapon2.NAME + "</b>";
				...
				spreadDataHIP[0][1] = "<html><b>" + weapon1.NAME + "</b>"; 
				spreadDataHIP[0][2] = "<html><b>" + weapon2.NAME + "</b>";
				...
				spreadDataHIP[4][1] = "<html><b>" + weapon1.NAME + "</b>"; 
				spreadDataHIP[4][2] = "<html><b>" + weapon2.NAME + "</b>";
